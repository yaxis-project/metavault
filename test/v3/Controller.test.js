    ...
    describe('harvestStrategy', () => {
        ...
        context('when strategy exists', () => {
            ...
            it('should harvest', async () => {
                await expect(harvester.harvest(controller.address, strategyCrv.address, [0, 0, 0, 0, 0, 0, 0, 0]))
            ...
            it('should revert if the system is halted', async () => {
                await manager.setHalted();
                await expect(
                    harvester.harvest(controller.address, strategyCrv.address, [0, 0, 0, 0, 0, 0, 0, 0])
                ).to.be.revertedWith('halted');
            });
        });
    });
